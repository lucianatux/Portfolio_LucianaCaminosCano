...
export class ExperienciaService {
  ...
  public save(experiencia: Experiencia): Observable<any>{
    return this.httpClient.post<any>(this.expURL + 'crearexperiencia', experiencia);
  }

  public update(id: number, experiencia: Experiencia): Observable<any>{
    return this.httpClient.put<any>(this.expURL + `actualizarexperiencia/${id}`, experiencia);
  }
